package com.trading.report_service.messaging;

import com.trading.common.event.*;
import com.trading.common.messaging.idempotency.ProcessedEvent;
import com.trading.common.messaging.idempotency.ProcessedEventRepository;
import com.trading.report_service.model.projection.*;
...
public class ProjectionEventListener {
     ...
     */
    @RabbitListener(queues = "#{T(com.trading.common.config.RabbitMQConfig).TRADE_EXECUTED_REPORT_QUEUE}", containerFactory = "rabbitListenerContainerFactory")
    @Transactional
     ...
     */
    @RabbitListener(queues = "#{T(com.trading.common.config.RabbitMQConfig).FUNDS_DEPOSITED_REPORT_QUEUE}", containerFactory = "rabbitListenerContainerFactory")
    @Transactional
     ...
     */
    @RabbitListener(queues = "#{T(com.trading.common.config.RabbitMQConfig).FUNDS_WITHDRAWN_REPORT_QUEUE}", containerFactory = "rabbitListenerContainerFactory")
    @Transactional
