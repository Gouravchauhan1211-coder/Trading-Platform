...
public class TradeEventListener {
    ...
    public void handleTradeFailed(com.trading.common.event.TradeFailedEvent event) {
    ...
    public void handleTradeCancelled(com.trading.common.event.TradeCancelledEvent event) {
